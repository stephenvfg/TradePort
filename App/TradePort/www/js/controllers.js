...
angular.module('starter.controllers', [])
    ...
    .controller('PurchasesCtrl', function($scope, Chats, Purchase, Product, Currency, User, $ionicScrollDelegate) {
        var canLoadMore = true;
        $scope.purchases = [];
    ...
    .controller('TradeCurrencyCtrl', function ($scope, User, Currency) {
        ...
        $scope.currencyChanged = function () {
            ...
            if (!$scope.currency.have || !$scope.currency.need) {
                return;
            }

            $.each(currenciesRates, function (k, currencyObj) {
                if (currencyObj.currency === $scope.currency.have) {
                    $scope.currency.exchangeRate = currencyObj.exchangeRate[$scope.currency.need];
                    return false;
                }
            })
        }
